...
def cal_cosine_distance(x=[], y=[]):
    ...
    kl = cosine(x_number, y_number)
    return str(kl)


def cal_cosine_distance_demo():
    value = cosine([3, 5, 1], [1, 2, 3])
    print(value)
...
if __name__ == '__main__':
    ...
    for stock in stock_list:
        ...
        print(stock, cal_cosine_distance(t_vol_list, vol_list))
        print(stock, cal_cosine_distance(vol_list, t_vol_list))
    cal_cosine_distance_demo()
